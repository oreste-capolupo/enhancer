...
public class EspressoCommands {
	private static String[] commands = { "actionOnHolderItem", "actionOnItem", "actionOnItemAtPosition",
			...
			"hasValue", "hasWindowLayoutParams", "instanceOf", "is", "isAbove", "isAssignableFrom", "isBelow",
			...
			"navigateTo", "noEllipseizedText", "noMultilineButtons", "noOverlaps", "not", "open", "openDrawer",
			"openLink", "openLinkWithText", "openLinkWithUri", "pressBack", "pressBackUnconditionally",
			"pressIMEActionButton", "pressKey", "pressMenuKey", "removeGlobalAssertion", "repeatedlyUntil",
			"replaceText", "scrollLeft", "scrollRight", "scrollTo", "scrollTo", "scrollToFirst", "scrollToHolder",
			"scrollToLast", "scrollToPage", "scrollToPosition", "selectedDescendantsMatch", "setData", "setTime",
			"startsWith", "supportsInputMethods", "swipeDown", "swipeLeft", "swipeRight", "swipeUp", "toPackage",
			"typeText", "typeTextIntoFocusedView", "withAlpha", "withChild", "withClassName", "withContentDescription",
			"withDecorView", "withEffectiveVisibility", "withHint", "withId", "withInputType", "withKey", "withParent",
